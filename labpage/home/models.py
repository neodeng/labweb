...
class New(models.Model):
    ...
    content_en=models.TextField(max_length=500, verbose_name=u'英文内容')
...
class Memberss(models.Model):
    ...
    name_en= models.CharField(max_length=20, verbose_name=u'英文姓名')
    photo=models.FileField(upload_to='members')
    address=models.CharField(max_length=30, verbose_name=u'地址')
    address_en=models.CharField(max_length=30, verbose_name=u'英文地址')
...
class Researchs(models.Model):
    ...
    describe=models.TextField(max_length=1000, verbose_name=u'介绍')
    name_en=models.CharField(max_length=50, verbose_name=u'研究领域英文')
    describe_en=models.TextField(max_length=1000, verbose_name=u'介绍英文')
...
class Facilitys(models.Model):
    ...
    name_en=models.CharField(max_length=50, verbose_name=u'仪器系统名称英文')
